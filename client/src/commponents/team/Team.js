    ...
    const sliders = [
        {
            ...
            linkedin: 'https://www.linkedin.com/in/vadym-klius-0000000000/',
        },
        {
            image: '/image/team/team-2.png',
            name: 'Maxim Britsky',
            proffesion: 'Business Analyst',
            about: 'Bridges the gap between business needs and technical solutions. Responsible for analyzing processes, gathering requirements, and driving data-informed decisions.',
            linkedin: '',
        },
        {
            image: '/image/team/team-3.png',
            name: 'Volodymyr Prodanyuk',
            proffesion: 'CIO',
            about: 'Oversees the company’s technology strategy and infrastructure. Responsible for aligning IT initiatives with business goals and ensuring digital innovation.',
            linkedin: '',
        },
        {
            image: '/image/team/team-4.png',
            name: 'Taras Kononko',
            proffesion: 'AI Automation Specialist',
            about: 'Develops and manages automation systems to improve efficiency. Focused on using AI tools to streamline operations and reduce manual workload.',
            linkedin: '',
        },
        {
            image: '/image/team/team-5.png',
            name: 'Safie Dzhabbarova',
            proffesion: 'Designer',
            about: 'Сrafts visually compelling and user-centered designs. Focused on creating intuitive interfaces and cohesive brand experiences across platforms.',
            linkedin: '',
        },
