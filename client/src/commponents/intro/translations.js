export const translations = {
	en: {
		...
		description:
			"Your AI Agent is more than a tool — it's a team member. It learns your processes, talks to clients, and executes tasks — so you can focus on what really matters.",
		...
		initialMessage:
			"Hi there! I'm your personal assistant here to help you explore our ice cream selection and services.\nLet me know what you'd like to know!",
	...
	uk: {
		// IntroForm translations
		title: "Знайомтесь із вашим AI-агентом",
		description:
			"Ваш AI-агент — це більше, ніж просто інструмент — це повноцінний член команди. Він вивчає ваші процеси, спілкується з клієнтами та виконує завдання — щоб ви могли зосередитися на справді важливому.",
		instruction: "Просто вставте посилання нижче",
		...
		initialMessage:
			"Привіт! Я ваш персональний асистент, готовий допомогти вам дослідити наш асортимент морозива та послуги.\nПовідомте мені, що ви хотіли б дізнатися!",
		placeholder: "Запитайте питання...",
