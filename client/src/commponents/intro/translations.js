export const translations = {
	...
	uk: {
		...
		description:
			"AI-агент — це не просто інструмент, а повноцінний член команди. Він вивчає ваші процеси, спілкується з клієнтами та виконує завдання — щоб ви могли зосередитися на важливому.",
