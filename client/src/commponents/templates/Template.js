  ...
  return (
    <section className="section-2 flex gap-[70px] mob:flex-col" id="templates">
      <div className="min-w-[418px] flex flex-col">
        ...
        <h2 className="text-linear title-2 mt-[10px] w-full sm:w-auto max-w-[60%] sm:max-w-full">
          Smart Templates for Recruiters
        </h2>

        <p className="title-3 text-[#818181] mt-[15px] max-w-[274px]">
          Boost your hiring workflow with pre-built Notion templates — fully
      ...
      <div className="swiper-parent flex flex-col gap-[25px]">
        ...
        >
          {sliders.map((item, index) => (
            <SwiperSlide
              key={index}
              className="slide cases-swiper-slide saas-hover-effect rounded-[20px] bg-white shadow-md flex-col justify-between h-[calc(100% - 20px)]"
            >
              ...
              <div className="p-[20px] flex flex-col justify-between ">
                ...
                <div className="mt-[10px] flex gap-[15px]">
                  ...
                  <button className="black-btn w-full py-[13px] ">
                    Learn more
                  </button>
                </div>
              </div>
        ...
        <div className="w-full flex justify-between items-center pr-[120px]">
          <div className="flex items-center gap-[50px] mob:hidden">
            <div
              className={`template-swiper-button-prev swiper-button-prev cursor-pointer swiper-control-btns ${atStart ? "disabled-button-class" : ""}`}
            >
              ←
            </div>
            <div
              className={`template-swiper-button-next swiper-button-next cursor-pointer swiper-control-btns ${atEnd ? "disabled-button-class" : ""}`}
            >
              →
            </div>
          </div>
