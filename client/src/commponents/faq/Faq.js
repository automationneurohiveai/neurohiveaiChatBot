...
export default function Faq() {
  ...
  const info = [
    [
        ...
        articles: [
          {
            ...
            texts: {
              text1:
                "Discover the scope and power of workflow automation with NeuroHive",

              text2:
                "Automation is no longer a future-facing concept — it’s a present-day necessity. At NeuroHive, we focus on helping businesses streamline operations, reduce costs, and unlock productivity by automating the processes that drain time, attention, and human energy.",
          ...
          },
          {
            ...
            texts: {
              text1:
                "Many business teams spend a significant portion of their day performing low-value, repetitive tasks that are perfect candidates for automation. NeuroHive can help you:",
              stats: [
              ...
              text2:
                "By automating these workflows, your team can focus on tasks that actually move the business forward — like analysis, strategy, and customer service.",
            },
          },
          {
            ...
            texts: {
              text1:
                "Financial teams often deal with tight deadlines, compliance constraints, and large volumes of data. NeuroHive makes it easy to automate:",
              stats: [
                "Invoice processing",
              ...
              text2:
                "With NeuroHive’s automated reporting module, finance teams can cut reporting time in half and eliminate manual errors.",
            },
          },
        ],
      },
      ...
      {
        title:
          "NeuroHive launches automated reporting module for finance teams",
        articles: [
          {
            title:
              "NeuroHive launches automated reporting module for finance teams",
        ...
        articles: [
          {
            ...
            texts: {
              text1:
                "Learn how to quickly onboard, create your first automation, and integrate essential tools.Guide includes: ",
          ...
          },
          {
            ...
            texts: {
              text1:
                "To get started with NeuroHive, you first need to create an account. Simply go to the sign-up page and register using your business email. Once you verify your email, you’ll have access to your personal workspace where you can manage your automations, templates, and integrations.",
          ...
          },
          {
            ...
            texts: {
              text1:
                "Once your account is active, you’ll be prompted to select a template that fits your use case. NeuroHive offers a range of ready-made automation templates tailored for different business needs:",
              stats: [
                "Candidate Screening",
                "Invoice Reporting",
                "Task Notifications",
              ...
              text2:
                "Each template is fully customizable. You can preview the workflow before launching or modify it to suit your internal logic.",
            },
          },
        ],
      },
    ...
    <div className="section pt-[150px] pb-[100px] flex gap-[90px] mob:flex-col mob:gap-[40px]">
      <div className="py-[20px] px-[30px] pr-[10px] rounded-[15px] drop-shadow min-w-[400px] max-w-[400px] h-[500px] bg-[#f1f1f1c2] overflow-hidden mob:max-w-full mob:min-w-full mob:h-fit mob:items-center mob:flex mob:flex-col">
        <div className="flex items-center justify-center w-full pr-[10px]">
          <p
            className={`title-3 pb-[14px] border-b-2 flex-grow text-center cursor-pointer ${
              data === 0
                ? "text-black border-black"
                : "text-[#818181] border-[#818181]"
            } `}
          ...
          {info[data].map((item, index) => (
            ...
            >
              <div className="flex justify-between">
                <p
                  className={`subtitle-16 ${activeIndex === index ? "text-[#fb5d21]" : "text-[#818181]"}`}
                >
                  {item.title}
                </p>
                {!isDesktop && (
                  <svg
                    className="min-w-[16px] min-h-[14px]"
                    width="16"
                    height="20"
                    viewBox="0 0 16 20"
                    fill="none"
              ...
              {!isDesktop && activeIndex === index && (
                <div className="max-h-[475px] overflow-y-auto">
                  {item.articles.map((article, idx) => (
                    ...
                    >
                      {Object.entries(article.texts).map(
                        ([key, value], textIndex) => (
                          <div key={textIndex}>
                            {textIndex === 1 &&
                            key === "stats" &&
        ...
        {!isDesktop && <button className="more">View more</button>}
      </div>
      ...
      <div className="flex flex-col gap-[40px]">
        ...
        <div className="flex flex-col gap-[40px] max-w-[407px]">
          <h3 className="title-3">
            See potential for automation in your own workflow? Get in touch with
            us, and our expert will guide you through the first steps.
          </h3>
          <div className="flex gap-[20px]">
            <button
              className="black-btn py-[16px] w-[326px]"
              onClick={() => {
