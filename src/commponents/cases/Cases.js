...
export default function Cases() {
  ...
  return (
    <section className="section-2 flex flex-col gap-[30px]" id="cases">
      <div className="max-w-[1200px] flex items-end justify-between mob:max-w-full">
        ...
        <div className="flex items-end justify-end h-full mob:hidden">
          <div className="flex items-center gap-[50px]">
            <div
              className={`cases-swiper-button-prev swiper-button-prev cursor-pointer swiper-control-btns ${atStart ? "disabled-button-class" : ""}`}
            >
              ←
            </div>
            <div
              className={`cases-swiper-button-next swiper-button-next cursor-pointer swiper-control-btns ${atEnd ? "disabled-button-class" : ""}`}
            >
              →
            </div>
          </div>
      ...
      {isDesktop ? (
        ...
        >
          {sliders.map((item, index) => (
            <SwiperSlide
              key={index}
              className="case-slide slide cases-swiper-slide rounded-[20px] bg-white shadow-md flex-col justify-between h-[calc(100% - 20px)]"
            >
              ...
              <div className="p-[30px] flex flex-col justify-between flex-grow">
                <div className="flex flex-col  h-auto">
                  ...
                  <div className="flex flex-col gap-[15px] mt-[10px]">
                    ...
                    <div className="flex gap-[13px] items-center">
                      <p className="txt-caption whitespace-nowrap">
                        AI Action:{" "}
                      </p>
                ...
                <button className="black-btn w-full py-[13px] mt-[20px]">
                  Learn more
                </button>
              </div>
            </SwiperSlide>
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <button className="href-btn m-auto mt-[30px] hidden mob:flex">
            View more
          </button>
        </div>
      )}
