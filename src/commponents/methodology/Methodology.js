    ...
    return (
        <section className='section flex flex-col gap-[30px]'>
            <div className='flex gap-[68px] mob:flex-col mob:gap-[10px]'>
                ...
                <p className='title-3 text-[#818181] pr-[50px] mt-[50px] mob:mt-0 mob:pr-0'>A clear roadmap to help your team implement AI confidently and effectively. From evaluating opportunities and setting goals to ensuring compliance and scaling — each step moves you closer to smart, ethical AI integration.</p>
            </div>
                            ...
                            <div className='flex items-center justify-between'>
                                ...
                                <svg width="15" height="16" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_6100_2167)">
                                        <path d="M7.5 1.85553L7.5 14.841" stroke="#818181" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M2.25 9.97147L7.5 14.841L12.75 9.97147" stroke="#818181" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </g>
                                    <defs>
                            ...
                            {index === activeMethod && (
                                <div className='flex flex-col'>
                                    ...
                                    <div className='shadow-2xl rounded-[10px] overflow-hidden mt-[20px]'>
                                        <img src={`${method.gif}`} className='w-full h-[240px] object-cover rounded-[10px] ' />
                                    </div>
                                </div>
                            )}
                        </div>
