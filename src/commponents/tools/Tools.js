            ...
            <div className="flex flex-col gap-[20px]">
                <div className="flex gap-[20px] mob:flex-col">
                    <div className="mob:w-full mob:flex-col w-1/2 flex gap-[15px] py-[30px] pl-[30px] pr-[45px] bg-white shadow-xl rounded-xl">
                        <div className="flex gap-[15px] w-fit shrink-0 mob:items-center">
                            <img src={`${process.env.PUBLIC_URL}/image/tools/dislike.svg`} className="w-[40px] h-[40px] mob:w-[30px] mob:h-[30px]" />
                            <h3 className="subtitle-1 whitespace-pre-line mob:whitespace-normal">Business{"\n"}
                                Pain</h3>
                        </div>
                    ...
                    <div className="mob:w-full mob:flex-col w-1/2 flex gap-[15px] py-[30px] pl-[30px] pr-[45px] bg-white shadow-xl rounded-xl">
                        <div className="flex gap-[15px] w-fit shrink-0 mob:items-center">
                            <img src={`${process.env.PUBLIC_URL}/image/tools/like.svg`} className="w-[40px] h-[40px] mob:w-[30px] mob:h-[30px]" />
                            <h3 className="subtitle-1 whitespace-pre-line mob:whitespace-normal">NeuroHive{"\n"}Solution</h3>
                        </div>
                ...
                <div className="rounded-[20px] shadow-xl bg-[#F7F7F7]">
                    {isDesktop ? (
                        ...
                        <img src={`${process.env.PUBLIC_URL}/image/tools/mob-tools.svg`} className="object-cover w-full" />
