...
export default function Autamatation() {
    ...
    return (
        <section className="section flex flex-col items-center">
            ...
            <p className="txt-18 mt-[10px] text-[#818181] whitespace-pre-line ">We don’t sell technology — we
                deliver return on investment.</p>
            <button className="black-btn py-[13px] px-[49.5px] mt-[20px]">Calculate ROI for my business</button>
            <div className="w-full grid gap-[20px] mt-[30px] grid-cols-5 ">
                ...
                <div className="automat-item automat-item2 flex gap-[28px] rounded-[8px] p-[40px] ">
                ...
                <div className="automat-item automat-item3 flex p-[40px] rounded-[8px] ">
                    <div className='flex flex-col gap-[10px]'>
                    ...
                    <img src={`${process.env.PUBLIC_URL}/image/automat/automat3.svg`} className="w-323px object-cover mt-[56px] " />
                </div>
                ...
                <div className="automat-item automat-item6 flex gap-[24px] rounded-[8px] p-[40px] ">
                    <div className='flex flex-col gap-[10px]'>
                    ...
                    <div className='rounded-2xl overflow-hidden w-405px  mt-[72px] shadow-xl'>
                        <img src={`${process.env.PUBLIC_URL}/image/automat/automat6.svg`} className='object-cover' />
                    </div>
                </div>
            </div>
                <button className='href-btn m-auto mt-[30px] hidden '>View more</button>
        </section>
    )
}