    ...
    <section className="section flex gap-[66px] mob:flex-col">
      <div className="flex flex-col justify-between max-w-[420px]">
        <div>
          ...
          <h2 className="text-linear title-2 mt-[16px]">
            Frequently Asked Questions
          </h2>
          <p className="mt-[20px] title-3 text-[#818181] max-w-[386px]">
      ...
      {!isDesktop && (
        <div>
          ...
          <p className="subtitle-16 text-[#818181] mt-[8px]">
            If you didn’t find the answer you were looking for, feel free search
            for an answer in our Knowledge Hub.
          </p>
          <button className="black-btn mt-[20px] py-[16px] w-full">
            Go to Hub{" "}
          </button>
        </div>
      )}
