...
return (
    <section className="section flex gap-[66px]">
        ...
        <div className="flex flex-col gap-[15px] flex-grow">
            ...
            {/* <div className="question-item question-item-active">
                    <div className="question-title">
                        <h3 className="title-3 text-[#818181]">What kind of processes can NeuroHive automate?</h3>
                        <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8 1.43553L8 18.479" stroke="#818181" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M1 12.0877L8 18.479L15 12.0877" stroke="#818181" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    ...
                    <div>
                        <p className="main-txt text-[#818181]">NeuroHive automates repetitive, rule-based tasks across HR, finance, operations, and more — from data entry and reporting to candidate screening and email routing.</p>
                    </div>
                </div> */}
        </div>
    </section>
