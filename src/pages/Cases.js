    ...
    <div className="flex flex-col gap-[150px] mob:gap-[120px]">
      ...
      <section className="strategy">
        <div className="w-full mob:max-w-[347px] flex flex-col items-center text-center">
          <p className="title-3 text-[#FB5D21]">
            Ready to automate your workflow?
          </p>
          <h2 className="title-2 text-white mob:text-center mt-[5px]">
            Let’s build your automation together
          </h2>
          <p className="title-3 text-[#818181] max-w-[447px] mt-[10px]">
            We’ll show you how NeuroHive AI can eliminate routine work, step by
            step. No pressure — just a quick conversation to see if it fits your
            process.
          </p>
